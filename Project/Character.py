...
class Character(QFrame):
    ...
    def initCharacter(self, parent,  x, y, characterName, points):
        ...
        if x < 900:
            self.pLabel.move(100, 40)
            self.lLabel.move(100, 5)
            self.livesLabel.move(200, 2)
            self.pointsLabel.setGeometry(200, 10, 100, 100)
            ...
            self.pLabel.move(1675, 40)
            self.lLabel.move(1675, 5)
            self.livesLabel.move(1775, 2)
            self.pointsLabel.setGeometry(1775, 10, 100, 100)
